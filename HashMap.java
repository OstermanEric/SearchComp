...
public class HashMap<K, V> {
	...
	/**
	 * contains method added to find key in HashMap
	 * if key is found returns true, else returns false
	 * 
	 * @param key of generic type K, what is being searched for
	...
	/**
	 * collisions method that records maximum number of collisions found
	 * collisions occur when 2 values are equal and linked list is created at that index to store the equal values
	 * @return size of the longest linked list which is max number of collisions at one index
	 */
